...
class FaultInjectingMCPToolSession:
    """Injects deterministic MCPToolError failures on declared calls.
    All other calls delegate to the real MCP session.
    This measures recovery from genuine MCP tool failures."""
